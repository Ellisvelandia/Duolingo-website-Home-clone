...
const Efficacy = () => {
  return (
    <div className="flex flex-row items-center m-auto p-10 max-w-6xl">
      <div className="ml-6 flex lg:flex-row flex-col">
        <img
          src="https://d35aaqx5ub95lt.cloudfront.net/images/776364e6419216ffd84ddf8d8815711b.svg"
          alt="duolingo"
          className="h-[145px] min-h-[185px] mr-12 flex-grow-0 object-contain  xl:mb-0 mb-12"
        />
        <div className="w-full"> 
          <h2
            className="font-bold text-[#3c3c3c] text-2xl leading-7"
